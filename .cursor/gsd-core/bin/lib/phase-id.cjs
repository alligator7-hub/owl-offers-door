 ...
 * can never diverge — see .cursor/rules/'s "Generative Fix Divergence" note: this
 ...
 * normalization — .cursor/rules/'s Generative Fix Divergence class):
 ...
 * re-derived per site (.cursor/rules/'s Generative Fix Divergence class).
