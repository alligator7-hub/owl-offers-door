  ...
  "external-job": {
    ...
    "config": {
      ...
      "external_job.submit_timeout_ms": {
        "type": "number",
        "default": 30000,
        "description": "Hard timeout (ms) for the scheduler submit subprocess (e.g. sbatch). Bounded per .cursor/rules/ unbounded-subprocess policy. Read by the adapter (env GSD_SLURM_SUBMIT_TIMEOUT_MS overrides)."
      },
  ...
  "mempalace": {
    ...
    "config": {
      ...
      "mempalace.auto_capture_hooks": {
        "type": "boolean",
        "default": false,
        "description": "Reserved / not yet implemented: will install MemPalace's native stop/precompact Cursor hooks for passive mid-session capture (the capability's hooks array is currently empty)."
      }
    },
    "steps": [
      {
    ...
    "steps": [
      {
        ...
        "fragment": {
          "path": "fragments/plan-pre.md",
          "inline": "<objective>\nResearch how to implement Phase {phase_number}: {phase_name}\nAnswer: \"What do I need to know to PLAN this phase well?\"\n</objective>\n\n<required_reading>\n- {context_path} (USER DECISIONS from /gsd-discuss-phase)\n- {requirements_path} (Project requirements)\n- {state_path} (Project decisions and history)\n</required_reading>\n\n${AGENT_SKILLS_RESEARCHER}\n\n<additional_context>\n**Phase description:** {phase_description}\n**Phase requirement IDs (MUST address):** {phase_req_ids}\n\n**Project instructions:** Read ./.cursor/rules/ or ./.claude/.cursor/rules/ if either exists; follow project-specific guidelines.\n**Project skills:** Check .cursor/skills/ or .agents/skills/ directory if either exists. Read SKILL.md files and account for project skill patterns.\n</additional_context>\n\n<output>\nWrite to: {phase_dir}/{phase_num}-RESEARCH.md\n</output>\n"
        },
        "produces": [
          "RESEARCH.md"
        ],
