 ...
 *                                                      runtime's config dir (e.g. driving Cursor from a
...
// prebuilt in the npm tarball. The Cursor plugin-marketplace channel never
...
// is removed at cutover so it reaches here; an unmigrated command still hits
  ...
  // if argv > 32,767 chars — .cursor/rules/ "Windows ARGV Overflow"). A pin over
