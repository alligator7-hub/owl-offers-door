...
<template>
@/workspace/.cursor/gsd-core/templates/UAT.md
</template>
...
Read and follow `/workspace/.cursor/gsd-core/workflows/transition.md`.
...
- Follow @/workspace/.cursor/gsd-core/workflows/diagnose-issues.md
