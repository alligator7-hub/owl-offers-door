...
```markdown
Read /workspace/.cursor/agents/gsd-ui-researcher.md for instructions.
...
Template: /workspace/.cursor/gsd-core/templates/UI-SPEC.md
</output>
...
```markdown
Read /workspace/.cursor/agents/gsd-ui-checker.md for instructions.
...
@/workspace/.cursor/gsd-core/references/ui-consideration-probe.md.
...
# (#448) — NOT the consuming project's git root — falling back to git toplevel / /workspace/.cursor.
...
UI_PROBE_JS=$(for _c in \
  ...
  "/workspace/.cursor/gsd-core/bin/lib/ui-consideration-probe.cjs" \
  "/workspace/.cursor/bin/lib/ui-consideration-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
