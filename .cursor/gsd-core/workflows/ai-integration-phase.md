...
<required_reading>
@/workspace/.cursor/gsd-core/references/ai-frameworks.md
...
```markdown
Read /workspace/.cursor/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "/workspace/.cursor/gsd-core/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read /workspace/.cursor/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read /workspace/.cursor/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read /workspace/.cursor/agents/gsd-eval-planner.md for instructions.
