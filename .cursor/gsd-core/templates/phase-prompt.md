...
<!-- For checkpoint task examples and patterns, see @/workspace/.cursor/gsd-core/references/checkpoints.md -->
...
See `/workspace/.cursor/gsd-core/references/tdd.md` for TDD plan structure.
...
See `/workspace/.cursor/gsd-core/templates/user-setup.md` for full schema and examples
