...
<reference>
@/workspace/.cursor/gsd-core/references/user-profiling.md
...
Read the user-profiling reference document at `/workspace/.cursor/gsd-core/references/user-profiling.md` to load:
