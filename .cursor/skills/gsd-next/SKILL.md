...
<execution_context>
@/workspace/.cursor/gsd-core/workflows/smart-entry.md
...
<process>
Follow /workspace/.cursor/gsd-core/workflows/smart-entry.md. Detect the situation, present the menu, and dispatch exactly one command. Then stop.
</process>
